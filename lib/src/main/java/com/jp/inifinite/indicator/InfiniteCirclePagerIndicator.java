...
/**
 * copy from https://github.com/JakeWharton/Android-ViewPagerIndicator/blob/master/library/src/com/viewpagerindicator/CirclePageIndicator.java
 * based on viewpagerinddicator lib to support infinite scroll
 */
public class InfiniteCirclePagerIndicator extends InfinitePageIndicator {
    ...
    public InfiniteCirclePagerIndicator(Context context) {
        this(context, null);
    }

    public InfiniteCirclePagerIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.ipiCirclePageIndicatorStyle);
    }

    public InfiniteCirclePagerIndicator(Context context, AttributeSet attrs, int defStyle) {
